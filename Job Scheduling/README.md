...
This directory contains two fundamental types of scheduling problems solved using **Greedy Algorithms**. The focus is on finding optimal or near-optimal sequences for tasks based on different constraints.
...
## 🚀 How to Use
Navigate to each subfolder for specific instructions and sample test cases. Each sub-module includes its own `README.md` with detailed problem descriptions and execution steps.
